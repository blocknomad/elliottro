...
class ViewComponent extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      screen: {
        ...
        exchanges:
          params.get("exchanges") && params.get("exchanges").split(","),
        quoteAssets:
          params.get("quoteAssets") && params.get("quoteAssets").split(","),
      },
    };
  ...
  render() {
    const { viewType, loading, matches, screen } = this.state;
      ...
      <>
        <div
          style={{
            ...
            padding: `20px ${config.padding.horizontal}`,
          }}
        >
          <ScreenSimplified />
        </div>
