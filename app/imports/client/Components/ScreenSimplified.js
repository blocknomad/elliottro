    ...
    this.state = {
      screen: {
        ...
        quoteAssets: (params.get("quoteAssets") &&
          params.get("quoteAssets").split(",")) || ["BTC"],
      },
    };
  }
      ...
      <Screen>
        <Form>
          ...
          <Select
            ...
            onChange={(event) =>
              this.handleChange("exchanges", event.target.value)
            }
            renderValue={(selected) =>
              selected.map((exchange) => Exchanges[exchange].name).join(", ")
            }
          ...
          <Select
            ...
            onChange={(event) =>
              this.handleChange("quoteAssets", event.target.value)
            }
            renderValue={(selected) =>
              selected
                .map((quoteAsset) => QuoteAssets[quoteAsset].name)
                .join(", ")
            }
