        ...
        >
          <DialogTitle id="responsive-dialog-title">
            {this.state.cancelledSubscription
              ...
              : `Cancel${
                  this.state.cancellingSubscription ? "ling" : ""
                } subscription`}
          </DialogTitle>
          <DialogContent>
            {this.state.cancellingSubscription ? (
              ...
              <DialogContentText>
                {this.state.cancelledSubscription
                  ? "Logging you out..."
                  : "Are you sure you would like to cancel your Pattern Dog subscription?"}
              </DialogContentText>
            )}
          </DialogContent>
          {this.state.cancellingSubscription === false &&
          this.state.cancelledSubscription === false ? (
            <DialogActions>
              <Button
                onClick={this.handleSubscriptionCancelling.bind(this)}
                color="primary"
                autoFocus
              >
                Yes
